        ...
        {points.map(p => {
          ...
          return (
            ...
            <div
              ...
              className="flex-1 rounded-t-sm bg-brand/60 hover:bg-primary focus-visible:bg-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50 transition-colors relative group cursor-help"
              style={heightStyle}
            >
