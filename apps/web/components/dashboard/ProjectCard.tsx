      ...
      <div className={cn(
        ...
        <div
          className={cn(
            ...
            thumbnailClickable && 'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50/60',
          )}
