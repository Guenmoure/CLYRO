    ...
    <div className="max-w-2xl space-y-8">
      ...
      <div className="flex flex-col items-center justify-center text-center py-12 px-8 rounded-2xl border border-dashed border-border bg-muted/30">
        <div className="relative mb-5">
          <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-brand/15 to-violet-500/15 blur-2xl" />
          <div className="relative w-16 h-16 rounded-3xl bg-gradient-to-br from-brand/10 to-violet-500/10 border border-border flex items-center justify-center">
