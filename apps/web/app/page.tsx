...
const MODULES = [
  {
    ...
    glow: 'hover:shadow-[0_0_48px_rgba(59,142,240,0.2)]',
    tag: 'Faceless',
    href: '/signup',
  ...
  },
  {
    ...
    glow: 'hover:shadow-[0_0_48px_rgba(155,92,246,0.25)]',
    tag: 'Motion',
    href: '/signup',
    ...
    <header className="fixed top-0 left-0 right-0 z-40 bg-navy-950/80 backdrop-blur-md border-b border-white/5">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/login"
            className="font-body text-sm text-white/50 hover:text-white transition-colors duration-200 px-3 py-1.5"
          >
            Sign in
          </Link>
          <Link
            href="/signup"
            className="shimmer font-body text-sm font-medium bg-gradient-to-r from-clyro-blue to-clyro-purple text-white px-4 py-1.5 rounded-xl hover:opacity-90 transition-opacity duration-200"
          >
            Get started free
          </Link>
        </div>
...
function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-24 pb-16 px-6 overflow-hidden">
      ...
      {/* Animated glow blobs */}
      <div className="animate-float absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[450px] bg-clyro-blue/6 rounded-full blur-3xl pointer-events-none" />
      <div className="animate-float-2 absolute top-1/3 left-1/4 w-[380px] h-[280px] bg-clyro-purple/6 rounded-full blur-3xl pointer-events-none" />
      <div className="animate-float-rev absolute top-1/3 right-1/4 w-[360px] h-[260px] bg-clyro-cyan/4 rounded-full blur-3xl pointer-events-none" />

      {/* Content */}
      <div className="relative z-10 max-w-3xl w-full mx-auto text-center">

        {/* Glassmorphism card — animate on load */}
        <div className="animate-fade-in rounded-3xl bg-navy-900/70 border border-white/8 px-8 py-10 backdrop-blur-md shadow-[0_0_80px_rgba(0,0,0,0.5)] mb-8">
          ...
          <h1 className="font-display font-extrabold leading-tight text-white mb-4">
            <span className="block text-3xl md:text-4xl text-white/60 font-semibold mb-2">
              Your script. Your brand. Your voice.
            </span>
            <span className="block text-5xl md:text-6xl lg:text-7xl text-gradient-animated">
              Your AI video.
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/signup"
              className="animate-glow-cta shimmer flex items-center gap-2 bg-gradient-to-r from-clyro-blue to-clyro-purple text-white font-body font-semibold text-sm px-6 py-3 rounded-xl hover:opacity-90 transition-opacity duration-200"
            >
              Create my first video <ArrowRight size={16} />
            </Link>
            <a
              href="#how-it-works"
              className="flex items-center gap-2 text-white/50 hover:text-white font-body text-sm px-5 py-3 rounded-xl border border-white/10 hover:border-white/25 transition-all duration-200"
            >
        ...
        {/* App mockup — slight delay */}
        <div className="reveal" style={{ '--reveal-delay': '200ms' } as React.CSSProperties}>
          <div className="relative rounded-2xl border border-white/8 bg-navy-900/90 overflow-hidden shadow-[0_32px_80px_rgba(0,0,0,0.6)]">
            ...
            <div className="p-6 grid grid-cols-3 gap-3">
              {[
                ...
                <div
                  key={style.label}
                  className={`bg-gradient-to-br ${style.color} border border-white/5 rounded-xl p-3 flex flex-col gap-2 card-hover`}
                >
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Reveal stagger>
          <div className="text-center">
            <p className="font-display font-extrabold text-4xl md:text-5xl text-gradient-animated">10 000+</p>
            <p className="font-mono text-xs text-white/35 uppercase tracking-widest mt-2">videos generated</p>
          </div>
          <div className="text-center">
            <p className="font-display font-extrabold text-4xl md:text-5xl text-gradient-animated">500+</p>
            <p className="font-mono text-xs text-white/35 uppercase tracking-widest mt-2">active creators</p>
          </div>
          <div className="text-center">
            <p className="font-display font-extrabold text-4xl md:text-5xl text-gradient-animated">6</p>
            <p className="font-mono text-xs text-white/35 uppercase tracking-widest mt-2">visual styles</p>
          </div>
          <div className="text-center">
            <p className="font-display font-extrabold text-4xl md:text-5xl text-gradient-animated">{'< 5 min'}</p>
            <p className="font-mono text-xs text-white/35 uppercase tracking-widest mt-2">per video</p>
          </div>
        </Reveal>
      </div>
    </section>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <Reveal className="text-center mb-16">
          ...
          <h2 className="font-display font-extrabold text-4xl md:text-5xl text-white mb-4">
            Three tools.{' '}
            <span className="text-gradient-animated">One platform.</span>
          </h2>
        ...
        <Reveal stagger className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {MODULES.map((mod) => {
            ...
            return (
              <div
                key={mod.id}
                className={`group relative bg-navy-900 border ${mod.border} ${mod.glow} rounded-3xl overflow-hidden card-hover`}
              >
                <div className={`h-40 bg-gradient-to-br ${mod.from} ${mod.to} flex items-center justify-center relative`}>
                  <div className="w-16 h-16 rounded-2xl bg-white/5 border border-white/8 flex items-center justify-center backdrop-blur-sm transition-transform duration-300 group-hover:scale-110">
                ...
                <div className="p-6">
                  <h3 className="font-display font-bold text-xl text-white mb-2 whitespace-pre-line">{mod.headline}</h3>
                  <p className="font-body text-sm text-white/45 leading-relaxed mb-5">{mod.desc}</p>
                  <Link
                    href={mod.href}
                    className="inline-flex items-center gap-2 font-body text-sm font-medium text-white/50 hover:text-white transition-colors duration-200 group/link"
                  >
                    Start creating
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <Reveal className="text-center mb-12">
          ...
          <h2 className="font-display font-extrabold text-3xl md:text-4xl text-white">
            Hundreds of{' '}
            <span className="text-gradient-animated">high-quality videos</span>
            {' '}every day
          </h2>
        </Reveal>
        ...
        <Reveal stagger className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {GALLERY.map((item) => (
            <div
              key={item.title}
              className="group relative bg-navy-900 border border-white/5 rounded-2xl overflow-hidden hover:border-white/15 card-hover cursor-pointer"
            >
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Reveal className="text-center mb-16">
          ...
          <h2 className="font-display font-extrabold text-4xl md:text-5xl text-white">
            Three steps.{' '}
            <span className="text-gradient-animated">One video.</span>
          </h2>
        </Reveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          {STEPS.map(({ number, icon, title, desc }, i) => (
            <Reveal key={number} delay={i * 120} className="flex flex-col items-center text-center gap-4">
              <div className="relative w-16 h-16 rounded-2xl bg-gradient-to-br from-clyro-blue to-clyro-purple flex items-center justify-center shadow-[0_0_24px_rgba(59,142,240,0.3)] transition-transform duration-300 hover:scale-110">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <Reveal stagger className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {TESTIMONIALS.map((t) => (
            <div
              key={t.name}
              className={`relative flex flex-col gap-4 rounded-2xl p-5 bg-gradient-to-br ${t.color} to-navy-900/50 border border-white/8 card-hover`}
            >
      ...
      <div className="max-w-5xl mx-auto">
        <Reveal stagger className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {ITEMS.map(({ icon: Icon, title, desc }) => (
            <div key={title} className="flex gap-4 p-5 bg-navy-900 border border-white/5 rounded-2xl hover:border-white/12 card-hover transition-colors duration-200">
    ...
    <section id="pricing" className="py-28 px-6 bg-navy-900/30">
      <div className="max-w-5xl mx-auto">
        ...
        <Reveal className="text-center mb-16">
          ...
          <h2 className="font-display font-extrabold text-4xl md:text-5xl text-white mb-4">
            Simple.{' '}
            <span className="text-gradient-animated">Transparent.</span>
          </h2>
        ...
        <Reveal stagger className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {PLANS.map((plan) => (
            <div
              key={plan.name}
              className={`relative flex flex-col bg-navy-900 rounded-2xl border p-6 card-hover ${
                plan.highlight
                  ? 'border-clyro-blue/50 shadow-[0_0_40px_rgba(59,142,240,0.12)] ring-1 ring-clyro-blue/20'
            ...
            >
              ...
              <Link
                href={plan.href}
                className={`text-center font-body font-medium text-sm py-2.5 rounded-xl transition-all duration-200 ${
                  plan.highlight
                    ? 'shimmer bg-gradient-to-r from-clyro-blue to-clyro-purple text-white hover:opacity-90'
      ...
      <div className="max-w-3xl mx-auto">
        <Reveal>
          <div className="relative rounded-3xl bg-navy-900 border border-clyro-blue/20 p-12 text-center overflow-hidden">
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_0%,rgba(59,142,240,0.1),transparent)] pointer-events-none" />
            ...
            <h2 className="font-display font-extrabold text-4xl md:text-5xl text-white mb-4 leading-tight">
              Start creating{' '}
              <span className="text-gradient-animated">for free</span>{' '}
              today.
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                href="/signup"
                className="animate-glow-cta shimmer flex items-center gap-2 bg-gradient-to-r from-clyro-blue to-clyro-purple text-white font-body font-semibold text-sm px-7 py-3 rounded-xl hover:opacity-90 transition-opacity duration-200"
              >
                Create my free account <ArrowRight size={16} />
              </Link>
              <Link
                href="/login"
                className="font-body text-sm text-white/40 hover:text-white px-5 py-3 rounded-xl border border-white/8 hover:border-white/20 transition-all duration-200"
              >
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <nav className="flex flex-wrap justify-center gap-6">
          {[
            ...
            <Link key={href} href={href} className="font-body text-xs text-white/30 hover:text-white transition-colors duration-200">
              {label}
            </Link>
          ))}
        </nav>
