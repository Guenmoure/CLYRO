  ...
  return (
    <div className="flex-1 overflow-y-auto bg-background px-6 py-8">
      <div className="max-w-3xl mx-auto space-y-6 animate-fade-in">
        ...
        {/* Page header */}
        <div>
          <p className="font-mono text-[11px] uppercase tracking-widest text-[--text-secondary] font-semibold mb-1">{t('set_account')}</p>
          <h1 className="font-display text-3xl font-bold text-foreground">{t('set_title')}</h1>
        ...
        <section className="rounded-2xl border border-border bg-card overflow-hidden">
          <header className="flex items-center gap-3 px-6 py-4 border-b border-border">
            ...
            <div>
              ...
              <p className="font-body text-xs text-[--text-secondary]">{t('set_profileDesc')}</p>
            </div>
          </header>
          <div className="p-6">
            <ProfileForm />
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <h2 className="font-display font-semibold text-foreground">{t('set_billing')}</h2>
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <h2 className="font-display font-semibold text-foreground">{t('set_whiteLabel')}</h2>
            <p className="font-body text-sm text-[--text-secondary] mt-0.5">
        ...
        <section className="rounded-2xl border border-border bg-card overflow-hidden">
          <header className="flex items-center gap-3 px-6 py-4 border-b border-border">
            ...
            <div>
              <h2 className="font-display font-semibold text-foreground">{t('set_security')}</h2>
              <p className="font-body text-xs text-[--text-secondary]">{t('set_securityDesc')}</p>
            </div>
          </header>
          <div className="p-6 space-y-4">
            ...
            >
              {resetting ? (
                <><Loader2 size={13} className="animate-spin" /> {t('set_sending')}</>
              ) : resetSent ? (
                <><Check size={13} /> {t('set_emailSent')}</>
              ) : (
                <>{t('set_sendResetLink')} →</>
              )}
            </button>
