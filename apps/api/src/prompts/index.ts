...
{
  "improvedPrompt": "the improved prompt in English (max 500 chars, must illustrate the SPECIFIC concept, not generic mood)",
...
Generate:
- imagePrompt: visual description in English for fal.ai Flux image generation (max 500 chars, match the ${style} style). Must illustrate the SPECIFIC concept from the script — use visual metaphor, comparison, storytelling object, or physical data. NEVER generic moods.
- animationPrompt: camera movement / motion description for Kling i2v (max 80 chars, concrete action)
